{{-- <div class="row" style="margin-top: 20px; min-height: 250px; background-color:rgb(117, 173, 230); padding: 10px 0;">
    <div class="col-md-12 text-center">
        <em class="text-center">&copy; 2025</em>
    </div>
</div> --}}


<footer class="mt-10 bg-gray-300">
    <div
